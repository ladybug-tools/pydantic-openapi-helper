...
latex_documents = [
    (master_doc, 'openapi-helper.tex', 'openapi helper Documentation',
...
man_pages = [
    (master_doc, 'openapi-helper', 'openapi helper Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'openapi-helper', 'openapi helper Documentation',
     author, 'openapi helper', 'One line description of project.',
     'Miscellaneous'),
]
